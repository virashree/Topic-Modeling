...
# result_dir = "/transient/viru/TopicAnalysisFiles/Tweets/"

dir = "Tweets/"
result_dir = "K_grams_files/"
...
for file in files:
    ...
    with open(dir + file, 'r') as f, open(result_dir+filename+'_tweets.txt', 'w') as f_o:
        ...
        for row in reader:
            try:
                ...
                if id not in tweet_ids:
                    ...
                    tweet = re.sub(user_mentions, "4username", tweet, re.VERBOSE | re.IGNORECASE)   # replacing usename
