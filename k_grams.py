...
dir = "/transient/viru/TopicAnalysisFiles/Tweets_cleaned/"
result_dir1 = "/transient/viru/TopicAnalysisFiles/K-grams/"
...
for file in files:
    ...
    with open(dir+file, 'r') as f, open(result_dir1+file, 'w') as f_pos: #, \
        ...
        for tweet in f:
            ...
            # recognizing sequence of one of more Noun and Adjective
            pattern = """
            chunk: {<N.*|JJ.*>+}
            """
