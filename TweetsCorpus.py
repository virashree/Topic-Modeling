...
def list_all_docs(docs):
    ...
    texts = list(docs)
    bigram = gensim.models.Phrases(docs, min_count=50, threshold=100)  # higher threshold fewer phrases.
    trigram = gensim.models.Phrases(bigram[docs], min_count=50, threshold=100)
    quadgrams = gensim.models.Phrases(trigram[docs], min_count=50, threshold=100)  # 50 70 100
...
class TweetsCorpus:
    ...
    def __init__(self, top_dir):
        ...
        self.corpus = [self.id2word.doc2bow(text) for text in self.list_docs if text != "eofeofeof"]
